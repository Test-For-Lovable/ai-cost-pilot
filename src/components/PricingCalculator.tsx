...
const PricingCalculator: React.FC<PricingCalculatorProps> = ({ emailSubmitted, setEmailSubmitted }) => {
  // Form state
  ...
  const handleEmailSubmit = (email: string) => {
    ...
    // In a real app, you'd send this email to your CRM/email marketing service
  };
  ...
  return (
    <div className="w-full space-y-6 animate-fade-in">
      {!emailSubmitted ? (
        <EmailCapture onSubmit={handleEmailSubmit} className="mb-6" />
      ) : (
        <ValueProposition />
      )}
